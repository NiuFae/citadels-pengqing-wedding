...
function showEggOptions() {
  ...
  document.getElementById('egg-gugu').onclick = () => {
    optPopup.remove();
    showEggText('希望鸽子们不管在哪，在做什么，都要照顾好自己，好好吃饭好好睡觉，好好生活，每一天都尽可能开开心心地度过！期待线下不鸽的一天！');
  };
  document.getElementById('egg-queen').onclick = () => {
    optPopup.remove();
    showEggText('尊敬的皇后殿下：在最开始设想角色卡时，我们就觉得，“国王”和“皇后”角色卡很适合被你们抽取。在游戏里，皇后和国王是彼此身边最温暖的陪伴，在现实中，你们也在互相守护、共同成长。不过在模拟游戏分支走向时，我发现皇后的技能很被动，没有办法主动吃钱，所以可能游戏的体验不是很好。在富饶之城，皇后没有主动技能，离开富饶之城，皇后可以成为任何人。祝吴璨、彭青在人生旅途上相互依偎，建造属于你们的城堡，主宰自己的王国~！');
  };
}
